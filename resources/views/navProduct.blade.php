...
<div class="py-5 mb-5 text-white rounded position-relative"
     style="background: url('{{ asset('images/background.jpg') }}') center/cover no-repeat; background-size: cover; margin-top: 0">
    <!-- Overlay -->
    <div class="position-absolute top-0 start-0 w-100 h-100"
         style="background: rgba(0,0,0,0.45); border-radius: 0;"></div>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm h-100 border-0 rounded-3 product-card">
...
.product-card:hover {
    transform: scale(1.07); /* lift more on hover */
    box-shadow:
        0 10px 20px rgba(0, 0, 0, 0.25),   /* base shadow */
        0 20px 40px rgba(0, 0, 0, 0.2);    /* deeper outer shadow */
    z-index: 10;
}
